...
MainRegion5: { //chapter 9 -- race 
  ...
  configObjects: {
    ...
    //    { type: "walk", direction: "up" , time: 2800},
      ...
      talking: [
        {
          required: ["COLLECTED_APPLE3"],  //herbs
          events: [
                { type: "textMessage", text: "Congrats, young one you've completed the quest!", faceHero: "trainerA" },
                { type: "textMessage", text: "You are a fine young man, you have earned my respect and a apple for the road to use during your race.", faceHero: "trainerA" },
                { type: "addItemToInventory", item: { actionId: "item_recoverHp", instanceId: "appleItem" } },//
                ...
                },
        {
          ...
          events: [
            ...
            { type: "textMessage", text: "I'm in need of a brave soul to go on a quest to fetch some rare apples & herbs for me placed around the apple orchard.", faceHero: "trainerA"},
           // { type: "battle", enemyId: "mark" },
          //  { type: "addStoryFlag", flag: "COLLECTED_APPLE3" },
          ]
      ...
      talking: [
        ...
        },
        {
          events: [
            ...
            { type: "textMessage", text: "Here is a hint, if you find any apples and carrots the horse will recover faster during the race.", faceHero: "trainer2" },
  ...
  configObjects: {
    ...
    trainer2 : {
      ...
      talking: [
        ...
        {
          events: [
            { type: "textMessage", text: "Congrat, you've made it to the new round in the race tournament! ", faceHero: "trainer2" },
            { type: "textMessage", text: "Ladies and gentlemen, it's time for the race of a lifetime! Hold onto your hats!", faceHero: "trainer2"},
            { type: "textMessage", text: "Here's an apple for the road.", faceHero: "trainer2"},
        //    { type: "addItemToInventory", item: { actionId: "item_recoverHp", instanceId: "appleItem" } },
            { type: "addStoryFlag", flag: "RACE_NPC" },
/// ADD RACE LIKE BATTLE HERE
